...
const HeroSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const heroContent = containerRef.current.querySelector(
        ".hero-content"
      ) as HTMLElement;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1502920917128-1aa500764cbd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80")',
